(function () {
  ...
  function creatorIdentity(p){const avatar=p.profilePhotoUrl?'<span class="creatorApplicantAvatar hasPhoto"><img src="'+escapeHtml(p.profilePhotoUrl)+'" alt=""></span>':'<span class="creatorApplicantAvatar">'+escapeHtml(p.initials)+'</span>';return'<div class="creatorApplicant">'+avatar+'<div><strong>'+escapeHtml(p.name)+'</strong><span>'+escapeHtml(p.email)+'</span></div></div>'}
