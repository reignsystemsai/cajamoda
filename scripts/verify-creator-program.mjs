...
const checks = [
  ...
  [server.includes('CREATOR_AGREEMENT_DISPLAY_VERSION = "15 de septiembre de 2026"') && !server.includes('versión ${CREATOR_AGREEMENT_VERSION}'), "Creator emails show the friendly agreement date while internal checks retain the technical version"],
